...
export type GetAthleteQuery = { __typename?: "Query" } & {
  getAthleteById: { __typename?: "Athlete" } & Pick<
    Athlete,
    "id" | "birthYear" | "parentEmail"
  > & {
      user: { __typename?: "User" } & Pick<
        User,
        "id" | "active" | "lastName" | "firstName" | "email"
      >;
    };
};
...
export type CreateAthleteProfileMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
...
export type GetBouldersInEventQuery = { __typename?: "Query" } & {
  getBouldersForEvent: Array<
    { __typename?: "Boulder" } & Pick<Boulder, "id" | "boulderNumber">
  >;
};
...
export type EventsQuery = { __typename?: "Query" } & {
  events: Array<
    { __typename?: "Event" } & Pick<
      Event,
      "name" | "location" | "id" | "startDate" | "numBoulders"
...
export type CreateEventMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "createEvent"
>;

export type GetAuthenticatedEventsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetAuthenticatedEventsQuery = { __typename?: "Query" } & {
...
export type GetEventQuery = { __typename?: "Query" } & {
  event: { __typename?: "Event" } & Pick<
    Event,
    "id" | "name" | "startDate" | "visible" | "location" | "numBoulders"
  > & {
      creator: { __typename?: "User" } & Pick<
        User,
        "lastName" | "firstName" | "id" | "email"
      >;
      runningOrder?: Maybe<
        { __typename?: "RunningOrder" } & Pick<RunningOrder, "id"> & {
            unordered: Array<
              { __typename?: "Stack" } & Pick<
                Stack,
                "id" | "gender" | "catagory"
...
export type RunningOrderFragment = { __typename?: "Event" } & {
  runningOrder?: Maybe<
    { __typename?: "RunningOrder" } & Pick<RunningOrder, "id"> & {
        unordered: Array<
          { __typename?: "Stack" } & Pick<Stack, "id" | "gender" | "catagory">
        >;
        first: Array<
          { __typename?: "Stack" } & Pick<Stack, "id" | "gender" | "catagory">
        >;
...
export type GetOrgQuery = { __typename?: "Query" } & {
  getOrganization: { __typename?: "Organization" } & Pick<
    Organization,
    "id" | "name"
  > & {
      owner: { __typename?: "User" } & Pick<User, "lastName">;
      teams: Array<{ __typename?: "Team" } & Pick<Team, "id" | "teamName">>;
      workouts: Array<
        { __typename?: "Workout" } & Pick<Workout, "id" | "name">
      >;
      athletes: Array<
        { __typename?: "Athlete" } & Pick<Athlete, "id" | "birthYear"> & {
            user: { __typename?: "User" } & Pick<
              User,
...
export type GetAthletesInOrgQuery = { __typename?: "Query" } & {
  getAthletesInOrg: Array<
    { __typename?: "Athlete" } & Pick<Athlete, "id"> & {
        team: { __typename?: "Team" } & Pick<Team, "teamName">;
        user: { __typename?: "User" } & Pick<User, "lastName" | "firstName">;
      }
  >;
};
...
export type GetTeamsInOrgQuery = { __typename?: "Query" } & {
  getTeamsInOrg: Array<{ __typename?: "Team" } & Pick<Team, "id" | "teamName">>;
};
...
export type EditRunningOrderMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "editRunningOrder"
>;
...
export type GetStacksForEventQuery = { __typename?: "Query" } & {
  getStacks: Array<
    { __typename?: "Stack" } & Pick<Stack, "id" | "gender" | "catagory">
  >;
};
...
export type CreateWorkoutMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "createWorkout"
>;
...
export type GetWorkoutQuery = { __typename?: "Query" } & {
  getWorkout: { __typename?: "Workout" } & Pick<
    Workout,
    "workoutType" | "name"
  >;
};
...
export type GetWorkoutsForTeamQuery = { __typename?: "Query" } & {
  getWorkoutsForTeam: Array<
    { __typename?: "Workout" } & Pick<Workout, "id" | "workoutType" | "name">
  >;
};
 ...
 * });
 */
export function useGetAthleteQuery(
  ...
  return Apollo.useQuery<GetAthleteQuery, GetAthleteQueryVariables>(
    GetAthleteDocument,
    options
  );
}
export function useGetAthleteLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetAthleteQuery, GetAthleteQueryVariables>(
    GetAthleteDocument,
    options
  );
}
export type GetAthleteQueryHookResult = ReturnType<typeof useGetAthleteQuery>;
export type GetAthleteLazyQueryHookResult = ReturnType<
  typeof useGetAthleteLazyQuery
>;
export type GetAthleteQueryResult = Apollo.QueryResult<
  GetAthleteQuery,
  GetAthleteQueryVariables
>;
...
`;
export type CreateAthleteProfileMutationFn = Apollo.MutationFunction<
  CreateAthleteProfileMutation,
  CreateAthleteProfileMutationVariables
>;
...
export function useCreateAthleteProfileMutation(
  ...
  return Apollo.useMutation<
    CreateAthleteProfileMutation,
    CreateAthleteProfileMutationVariables
  >(CreateAthleteProfileDocument, options);
}
export type CreateAthleteProfileMutationHookResult = ReturnType<
  typeof useCreateAthleteProfileMutation
>;
export type CreateAthleteProfileMutationResult =
  Apollo.MutationResult<CreateAthleteProfileMutation>;
export type CreateAthleteProfileMutationOptions = Apollo.BaseMutationOptions<
  CreateAthleteProfileMutation,
  CreateAthleteProfileMutationVariables
>;
 ...
 * });
 */
export function useGetBouldersInEventQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetBouldersInEventQuery,
    GetBouldersInEventQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetBouldersInEventQuery,
    GetBouldersInEventQueryVariables
  >(GetBouldersInEventDocument, options);
}
export function useGetBouldersInEventLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetBouldersInEventQuery,
    GetBouldersInEventQueryVariables
  >
...
export type GetBouldersInEventQueryHookResult = ReturnType<
  typeof useGetBouldersInEventQuery
>;
export type GetBouldersInEventLazyQueryHookResult = ReturnType<
  typeof useGetBouldersInEventLazyQuery
>;
export type GetBouldersInEventQueryResult = Apollo.QueryResult<
  GetBouldersInEventQuery,
  GetBouldersInEventQueryVariables
>;
 ...
 * });
 */
export function useGetAuthenticatedEventsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetAuthenticatedEventsQuery,
    GetAuthenticatedEventsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetAuthenticatedEventsQuery,
    GetAuthenticatedEventsQueryVariables
  >(GetAuthenticatedEventsDocument, options);
}
export function useGetAuthenticatedEventsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAuthenticatedEventsQuery,
    GetAuthenticatedEventsQueryVariables
  >
...
export type GetAuthenticatedEventsQueryHookResult = ReturnType<
  typeof useGetAuthenticatedEventsQuery
>;
export type GetAuthenticatedEventsLazyQueryHookResult = ReturnType<
  typeof useGetAuthenticatedEventsLazyQuery
>;
export type GetAuthenticatedEventsQueryResult = Apollo.QueryResult<
  GetAuthenticatedEventsQuery,
  GetAuthenticatedEventsQueryVariables
>;
 ...
 * });
 */
export function useGetAthletesInOrgQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetAthletesInOrgQuery,
    GetAthletesInOrgQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAthletesInOrgQuery, GetAthletesInOrgQueryVariables>(
    GetAthletesInOrgDocument,
    options
  );
}
export function useGetAthletesInOrgLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAthletesInOrgQuery,
    GetAthletesInOrgQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetAthletesInOrgQuery,
    GetAthletesInOrgQueryVariables
  >(GetAthletesInOrgDocument, options);
}
export type GetAthletesInOrgQueryHookResult = ReturnType<
  typeof useGetAthletesInOrgQuery
>;
export type GetAthletesInOrgLazyQueryHookResult = ReturnType<
  typeof useGetAthletesInOrgLazyQuery
>;
export type GetAthletesInOrgQueryResult = Apollo.QueryResult<
  GetAthletesInOrgQuery,
  GetAthletesInOrgQueryVariables
>;
 ...
 * });
 */
export function useGetTeamsInOrgQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetTeamsInOrgQuery,
    GetTeamsInOrgQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetTeamsInOrgQuery, GetTeamsInOrgQueryVariables>(
    GetTeamsInOrgDocument,
    options
  );
}
export function useGetTeamsInOrgLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetTeamsInOrgQuery,
    GetTeamsInOrgQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetTeamsInOrgQuery, GetTeamsInOrgQueryVariables>(
    GetTeamsInOrgDocument,
    options
  );
}
export type GetTeamsInOrgQueryHookResult = ReturnType<
  typeof useGetTeamsInOrgQuery
>;
export type GetTeamsInOrgLazyQueryHookResult = ReturnType<
  typeof useGetTeamsInOrgLazyQuery
>;
export type GetTeamsInOrgQueryResult = Apollo.QueryResult<
  GetTeamsInOrgQuery,
  GetTeamsInOrgQueryVariables
>;
export const EditRunningOrderDocument = gql`
  mutation editRunningOrder(
...
`;
export type EditRunningOrderMutationFn = Apollo.MutationFunction<
  EditRunningOrderMutation,
  EditRunningOrderMutationVariables
>;
 ...
 * });
 */
export function useEditRunningOrderMutation(
  baseOptions?: Apollo.MutationHookOptions<
    EditRunningOrderMutation,
    EditRunningOrderMutationVariables
  >
  ...
  return Apollo.useMutation<
    EditRunningOrderMutation,
    EditRunningOrderMutationVariables
  >(EditRunningOrderDocument, options);
}
export type EditRunningOrderMutationHookResult = ReturnType<
  typeof useEditRunningOrderMutation
>;
export type EditRunningOrderMutationResult =
  Apollo.MutationResult<EditRunningOrderMutation>;
export type EditRunningOrderMutationOptions = Apollo.BaseMutationOptions<
  EditRunningOrderMutation,
  EditRunningOrderMutationVariables
>;
 ...
 * });
 */
export function useGetStacksForEventQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetStacksForEventQuery,
    GetStacksForEventQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetStacksForEventQuery,
    GetStacksForEventQueryVariables
  >(GetStacksForEventDocument, options);
}
export function useGetStacksForEventLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetStacksForEventQuery,
    GetStacksForEventQueryVariables
  >
...
export type GetStacksForEventQueryHookResult = ReturnType<
  typeof useGetStacksForEventQuery
>;
export type GetStacksForEventLazyQueryHookResult = ReturnType<
  typeof useGetStacksForEventLazyQuery
>;
export type GetStacksForEventQueryResult = Apollo.QueryResult<
  GetStacksForEventQuery,
  GetStacksForEventQueryVariables
>;
...
export function useGetWorkoutQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetWorkoutQuery, GetWorkoutQueryVariables>(
    GetWorkoutDocument,
    options
  );
}
...
export type GetWorkoutLazyQueryHookResult = ReturnType<
  typeof useGetWorkoutLazyQuery
>;
export type GetWorkoutQueryResult = Apollo.QueryResult<
  GetWorkoutQuery,
  GetWorkoutQueryVariables
>;
 ...
 * });
 */
export function useGetWorkoutsForTeamQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetWorkoutsForTeamQuery,
    GetWorkoutsForTeamQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetWorkoutsForTeamQuery,
    GetWorkoutsForTeamQueryVariables
  >(GetWorkoutsForTeamDocument, options);
}
export function useGetWorkoutsForTeamLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetWorkoutsForTeamQuery,
    GetWorkoutsForTeamQueryVariables
  >
...
export type GetWorkoutsForTeamQueryHookResult = ReturnType<
  typeof useGetWorkoutsForTeamQuery
>;
export type GetWorkoutsForTeamLazyQueryHookResult = ReturnType<
  typeof useGetWorkoutsForTeamLazyQuery
>;
export type GetWorkoutsForTeamQueryResult = Apollo.QueryResult<
  GetWorkoutsForTeamQuery,
  GetWorkoutsForTeamQueryVariables
>;
